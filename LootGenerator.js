...
var LootGenerator = LootGenerator || (function () {
    ...
    randomWeapon = function (type = '') {
        ...
        if (type == 'swords') weapon = randomMundane(1, 'swords');
        else {
    ...
    commandConfig = function (msg) {
        ...
        if (typeof state['LootGenerator'].sheet == 'undefined' || state['LootGenerator'].sheet == 'Unknown') {
            ...
            message += '<b>Magic Items:</b> ' + state['LootGenerator'].defaults.magic + ' <a style="' + styles.imgLink + '" href="!loot --default ?{Magic Items Default|Show,show-magic|None,no-magic|Less,less-magic|More,more-magic}">✏️</a><br>';
